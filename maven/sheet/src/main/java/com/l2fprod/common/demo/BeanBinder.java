...
public class BeanBinder {
  ...
  public BeanBinder(Object bean, PropertySheetPanel sheet, BeanInfo beanInfo) {
    ...
    // If beanInfo is null, try to introspect the bean class directly.
    if (beanInfo == null && bean != null) {
      try {
        beanInfo = Introspector.getBeanInfo(bean.getClass());
      } catch (IntrospectionException e) {
        // ignore and fall back to empty properties
        beanInfo = null;
      }
    }
    ...
    if (beanInfo != null && beanInfo.getPropertyDescriptors() != null) {
      ...
      sheet.setProperties(new com.l2fprod.common.propertysheet.Property[0]);
    }
