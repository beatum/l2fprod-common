...
public class PropertySheetTable extends JTable {
  public static final String UI_CLASS_ID = "PropertySheetTableUI";

  // ensure at least the default ui is registered for this component
  static {
    LookAndFeelAddons.contribute(new com.l2fprod.common.swing.plaf.PropertySheetAddon());
  }
  ...
  public void updateUI() {
    try {
      ...
      // Fallback to default UI installation if addon initialization fails
      super.updateUI();
    }
  }
